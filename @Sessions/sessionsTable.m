...
varNames = { ...
    ...
    cell(nFiles,1), 'Box', '';...
    NaN(nFiles,1), 'Level', ''; ...
    cell(nFiles,1), 'WID', 'WeekID if level 9, 10, 11';
    cell(nFiles,1), 'DID', 'DayID if level 10 or 11';
    ...
    cell(nFiles,1), 'level11Seeds', ''; ...
    cell(nFiles,1), 'level11Offsets', ''; ...
    cell(nFiles,1), 'level11ActualAsMs', ''; ...
    cell(nFiles,1), 'seed2FileName', '';
    ...
    cell(nFiles,1), 'PreProFilt', 'Path to filtered folder, probably not saved'; ...
    cell(nFiles,1), 'PreProEpoch', 'Path to filtered/cleaned/epoched folder'; ...
    cell(nFiles,1), 'Spikes', 'Path to spikes folder'; ...
