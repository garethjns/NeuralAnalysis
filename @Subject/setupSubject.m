...
fPaths.neural.filtered = ['T:\Analysis\Behaving\', ...
    fParams.task, '\' fParams.subject2, '\Processing\'];
% Epoched directory
fPaths.neural.epoched = ['T:\Analysis\Behaving\', ...
    fParams.task, '\' fParams.subject2, '\Epoched\'];
% Spikes directory
fPaths.neural.spikes = ['T:\Analysis\Behaving\', ...
    fParams.task, '\' fParams.subject2, '\Spikes\'];


% Path for pre-processing cleaning graphs
fPaths.graphs.neuralCleaning = [fPaths.neural.epoched, ...
    'Cleaning\'];
% Path for pre-processing event graphs
fPaths.graphs.neuralEvents = [fPaths.neural.spikes, ...
    'Events\'];
